...
<!--HSX added block-upshift statements for headings -->
            <xsl:when test="$attrSet = 'upshift.1'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="upshift.1"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>

            <xsl:when test="$attrSet = 'upshift.2'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="upshift.2"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>

            <xsl:when test="$attrSet = 'upshift.3'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="upshift.3"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>

            <xsl:when test="$attrSet = 'upshift.4'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="upshift.4"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>

            <xsl:when test="$attrSet = 'upshift.5'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="upshift.5"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>

            <xsl:when test="$attrSet = 'upshift.6'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="upshift.6"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
