...
<!--
        use-attribute-sets="table.rule__top table.rule__bottom table.rule__left table.rule__right">
-->
    <xsl:attribute-set name="uicontrol"> <!--xsl:attribute-set> use-attribute-sets="table.rule__top table.rule__bottom table.rule__left table.rule__right" -->
