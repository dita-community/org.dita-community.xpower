...
<xsl:variable name="systemid">
    <xsl:choose>
        <xsl:when test="$infotype='concept'">http://docs.oasis-open.org/dita/v1.1/OS/dtd/concept.dtd</xsl:when>  
        <xsl:when test="$infotype='task'">http://docs.oasis-open.org/dita/v1.1/OS/dtd/task.dtd</xsl:when>  
        <xsl:when test="$infotype='reference'">http://docs.oasis-open.org/dita/v1.1/OS/dtd/reference.dtd</xsl:when>
        <xsl:otherwise>http://docs.oasis-open.org/dita/v1.1/OS/dtd/topic.dtd</xsl:otherwise>
<!--    
